  ...
  return (
    <div className="container mx-auto max-w-5xl animate-fade-in p-4 pb-24 md:p-8">
      ...
      <div className="mb-8 flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
        <div>
          <h1 className="flex items-center gap-3 text-2xl font-bold tracking-tight text-slate-900 dark:text-slate-100 sm:text-3xl">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            type="button"
            className="tactile-btn inline-flex min-h-[40px] items-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-2 text-xs font-semibold text-slate-700 shadow-sm transition-all hover:bg-slate-50 hover:text-slate-900 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300 dark:hover:bg-slate-800 dark:hover:text-slate-100"
                    ...
                    <div className="flex items-center gap-2 shrink-0 self-end sm:self-center">
                      {alert.source === 'task' ? (
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            type="button"
                            className="tactile-btn inline-flex min-h-[40px] items-center gap-1.5 rounded-xl bg-[#B5121B] px-3.5 py-2 text-xs font-semibold text-white shadow-sm transition-all hover:bg-[#8F0D16] focus:outline-none"
                        ...
                        <div className="inline-flex items-center gap-1.5 rounded-xl border border-emerald-200 bg-emerald-50 px-3 py-1.5 text-xs font-medium text-emerald-700 dark:border-emerald-800 dark:bg-emerald-950/40 dark:text-emerald-400">
